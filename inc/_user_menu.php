...
<li><a href="/account/serfing"<?=(isset($_GET["sel"]) && strtolower($_GET["sel"]) == "balance") ? 'class="selected"' : False; ?>>
	...
	Серфинг</a></li>
<li><a href="/account/polezno"<?=(isset($_GET["sel"]) && strtolower($_GET["sel"]) == "polezno") ? 'class="selected"' : False; ?>>
	<span class="fa fa-fw fa-money"></span>
	Помощник</a></li>	
<li><a href="/account/exchange.html"<?=(isset($_GET["sel"]) && strtolower($_GET["sel"]) == "exchange") ? 'class="selected"' : False; ?>>
	...
	Заказать выплату</a></li>
	
	<li><a href="/account/chat.html"<?=(isset($_GET["sel"]) && strtolower($_GET["sel"]) == "chat") ? 'class="selected"' : False; ?>>
	<span class="fa fa-fw fa-comments-o"></span>
	Чат проекта <div class="new_label">Новое!</div></a></li>
